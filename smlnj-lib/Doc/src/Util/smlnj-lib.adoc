...
xref:str-LEB128.adoc[`[.kw]#structure# LEB128`]::
  Provides binary encoding/decoding of integer and word types using the
  https://en.wikipedia.org/wiki/LEB128[Little-Endian-Base-128 (LEB128)] format.
...
xref:str-Trilean.adoc[`[.kw]#structure# Trilean`]::
  Provides an implementation of three-valued logic.
...
include::str-Trilean.adoc[]

include::str-UnivariateStats.adoc[]

include::str-URef.adoc[]

// 60 -- note that `str-Native.adoc` is referenced twice by the HTML,
