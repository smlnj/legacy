...
We also back-ported the following fixes from the development
version:
--
* https://github.com/smlnj/smlnj/issues/276[Issue 276 (`UTF8.getu` should validate
  that it's input is UTF-8)]
--
