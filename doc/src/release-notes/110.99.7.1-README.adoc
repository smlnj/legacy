...
This patch release fixes a critical bug in 110.99.7.  In addition, there is
a minor change that was planned for 110.99.8.  The changes
are:

* Fix for Issue #337 (compiler bug aborts build of istari)
