...
:dev-issue-base: https://github.com/smlnj/smlnj/issues
...
This release fixes a few bugs and should work on Linux 7.
...
* The "required privileges" message is no longer printed when the CM verbose
  flag is false
...
The ASDL tools and libraries have been updated to the latest version.

=== Documentation

=== Installation

self contained tarballs for Unix systems
...
| Gforge Bug
| [.bugid]#330#
| {issue-base}/330[REPL should always print reals as valid SML real literals]
| n.a.
| [.bugid]#353#
| {pull-base}/353[Inconsistent datatype representation causes segfault]
| n.a.
| [.bugid]#368#
| {pull-base}/368["bogus overflow fault" in code using functors]
| n.a.
| [.bugid]#374#
| {pull-base}/374[`OS.FileSys.tmpName` should support `TMPDIR`]
| n.a.
| [.bugid]#375#
| {issue-base}/375[Remove Linux version check from `_arch-n-opsys`]
| n.a.
|=======
