...
This release fixes a number of bugs and enables running on *Linux 7* and
...
| n.a.
| [.bugid]#353#
| {issue-base}/353[Inconsistent datatype representation causes segfault]
| n.a.
| [.bugid]#368#
| {issue-base}/368["bogus overflow fault" in code using functors]
| n.a.
| [.bugid]#375#
| {issue-base}/375[Remove Linux version check from `_arch-n-opsys`]
| n.a.
| [.bugid]#378#
| {issue-base}/378[SML/NJ crashes when `environ` is too big]
| n.a.
| [.bugid]#380#
| {pull-base}/380[properly initialize runtime system variables]
| n.a.
//| [.bugid]#@ID#
